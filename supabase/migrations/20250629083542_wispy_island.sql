/*
  ...
  1. New Tables
    - `leetcode_stats`
      ...
      - Various statistics fields for solved problems
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_proc WHERE proname = 'sync_leetcode_to_user_stats'
  ) THEN
    CREATE FUNCTION sync_leetcode_to_user_stats()
    RETURNS TRIGGER AS $$
    BEGIN
