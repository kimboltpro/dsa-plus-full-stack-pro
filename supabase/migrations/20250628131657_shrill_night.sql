/*
  # Create update_codolio_stats function

  1. Function Creation
    - Creates the `update_codolio_stats` function that the Edge Function is calling
    - Works with the existing `codolio_stats` table structure
    - Handles both INSERT and UPDATE operations using UPSERT logic

  2. Security
    - Grants execute permissions to authenticated users
    - Works with existing RLS policies on the codolio_stats table
*/
