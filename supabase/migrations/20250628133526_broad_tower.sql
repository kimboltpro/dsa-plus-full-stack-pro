/*
  ...
  2. Security
    ...
    - Add function for updating stats with proper permissions
...
-- Enable realtime for the codolio_stats table (check if not already added)
DO $$
BEGIN
    IF NOT EXISTS (
