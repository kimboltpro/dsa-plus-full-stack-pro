/*
  # Complete DSA Platform Database Schema

  1. New Tables
    - Enhanced profiles, topics, sheets, problems with better organization
    - User progress tracking with detailed analytics
    - Bookmarks, articles, interview questions, user stats
  ...
  4. Sample Data
    - Pre-populated topics for DSA roadmap
    - Popular coding interview sheets
*/
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM public.sheets LIMIT 1) THEN
