/*
  # Database Schema Setup for DSA Mastery Hub

  1. New Tables
    - Creates all necessary tables for the DSA learning platform
    - Includes user profiles, topics, sheets, problems, progress tracking, etc.
  ...
  3. Functions & Triggers
    ...
    - Create user profile and stats on registration
    
  4. Sample Data
    - Insert initial topics for DSA roadmap
    - Add popular problem sheets
*/
...
-- Insert sample sheets - only if not exists
